...
export const MultiStepForm: React.FC = () => {
    ...
    console.log("💡 productData.questions:", questions);
    if (!questions) {
        console.error("❌ questions is undefined! Check loaderData or productData shape.");
    }
    ...
    return (
        <div className="min-h-screen flex flex-col">
            <Header />
            <main className="flex-grow flex flex-col px-4 py-6 md:px-6">
                {isSubmitted ? (
                    <ResponsePage />
                ) : (
                    <Form
