    ...
    return (
        <div className="flex-grow">
            ...
            <div className="relative" ref={dropdownRef}>
                <div
className="select w-full p-2 border border-base-300 bg-base-100 rounded-input focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent mb-2 cursor-pointer"
                    onClick={(e) => {
                        e.stopPropagation();
