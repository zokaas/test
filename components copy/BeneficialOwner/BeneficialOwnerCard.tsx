...
export const BeneficialOwnerCard: React.FC<{
    ...
    <div className="p-4 mb-3 border border-base-300 bg-base-100 rounded-lg flex justify-between items-start hover:shadow-md transition-shadow">
        <div className="space-y-1">
            ...
            <div className="text-sm text-base-content/70">{owner.ssn}</div>
            <div className="text-sm font-medium text-primary">{owner.ownership}%</div>
            <div className="text-sm text-base-content/70">{owner.country}</div>
        </div>
